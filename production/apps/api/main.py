      ...
      <body>
            ...
            <div class="left-col">
              <section class="panel">
                ...
                <div class="panel-body">
                  <div class="query-box">
                    <textarea id="query">tìm quán cơm gà gần Bách Khoa dưới 50k, ưu tiên rating cao</textarea>
                  </div>

                  <div class="chips" aria-label="Quick queries">
                    <button class="chip" type="button" onclick="setQuery('tìm quán bún bò gần Bách Khoa dưới 50k')">Bún bò dưới 50k</button>
                    <button class="chip" type="button" onclick="setQuery('quán ăn trưa giá sinh viên, ưu tiên gần cổng parabol')">Ăn trưa sinh viên</button>
                    <button class="chip" type="button" onclick="setQuery('tìm quán trà sữa hoặc đồ uống gần Đại học Bách Khoa')">Đồ uống gần trường</button>
                    <button class="chip" type="button" onclick="setQuery('quán có rating cao, phù hợp đi nhóm 3 người')">Đi nhóm 3 người</button>
                  </div>
        ...
        <script>
          ...
          async function runRecommend() {
            ...
            const body = { query, algorithm: 'hybrid', top_k: 5 };
            if (currentLocation) {
            ...
            setLoading(true);
            results.innerHTML = '<div class="loading">Đang truy vấn GraphRAG/R-GCN và xếp hạng kết quả...</div>';
