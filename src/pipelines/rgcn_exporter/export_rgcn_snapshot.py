...
def export_rgcn_snapshot(settings: Settings) -> dict[str, object]:
    ...
    source_map = {
        "nodes.csv": settings.root.parent / "src" / "rgcn_pipeline" / "data" / "graphrag_nodes.csv",
        "edges.csv": settings.root.parent / "src" / "rgcn_pipeline" / "data" / "graphrag_edges.csv",
        "store_metadata.csv": settings.root.parent / "src" / "rgcn_pipeline" / "data" / "store_metadata.csv",
